...
public class TodoListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pathInfo == null) { // rien après le ServletPath ?
			...
			response.getWriter().append("<li><a href=\"http://127.0.0.1:8080/helloWeb/TodoListServlet/1\">todo list 1</a></li>");
			response.getWriter().append("<li><a href=\"http://127.0.0.1:8080/helloWeb/TodoListServlet/2\">todo list 2</a></li>");
			response.getWriter().append("</ul>");
			return;
		}
		...
		response.getWriter().append("<a href=\"http://127.0.0.1:8080/helloWeb/TodoListServlet\">retour vers accueil</a>");
		response.getWriter().append("<ul>");
